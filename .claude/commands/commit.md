...
5. Write a Conventional Commit with ticket scope (`fix(NWL-001): …`, `feat(SEO-005): …`, `docs(DOC-…): …`). Create the commit. No Co-Authored-By, no AI attribution, no session URLs in the message.
