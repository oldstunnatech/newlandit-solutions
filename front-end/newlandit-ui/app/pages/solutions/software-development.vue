  ...
  <section class="detail-page relative text-white overflow-hidden">
    ...
    <div class="relative z-10 max-w-5xl mx-auto px-6 pt-32 pb-24">
      ...
      <div class="text-center max-w-2xl mx-auto mb-12">
        <p class="eyebrow-pill mb-4">{{ t('detail.software.eyebrow') }}</p>
        <h1 class="text-xl sm:text-4xl font-extrabold mb-6">{{ t('detail.software.h1') }}</h1>

      </div>

      <div class="detail-card mb-16">
         <p class="text-lg leading-relaxed mb-8">
          {{ t('detail.software.intro') }}
        </p>
        <h2 class="text-xl font-bold mb-5">{{ t('detail.whatWeOffer') }}</h2>
        <ul class="offer-list mb-10">
          <li v-for="item in offers" :key="item">{{ item }}</li>
        </ul>
        <NuxtLink :to="localePath('/solutions/cms-websites')" class="btn-primary">{{ t('detail.software.moreBtn') }}</NuxtLink>
      </div>
...
const subMeta = [
  { image: '/images/pexels-a-darmel-8133993.jpg', href: '/contact' },
  { image: '/images/pexels-mikhail-nilov-9301316.jpg', href: '/contact' },
  { image: '/images/pexels-gustavo-fring-6285094.jpg', href: '/contact' },
]
const subSections = computed(() =>
  (tm('detail.software.sub') as any[]).map((s, i) => ({
