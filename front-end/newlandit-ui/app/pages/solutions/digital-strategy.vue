  ...
  <section class="detail-page relative text-white overflow-hidden">
    ...
    <div class="relative z-10 max-w-6xl mx-auto px-6 pt-32 pb-24">
      ...
      <div class="text-center max-w-2xl mx-auto mb-12">
        <p class="eyebrow-pill mb-4">{{ t('detail.strategy.eyebrow') }}</p>
        <h1 class="text-xl sm:text-4xl font-extrabold mb-6">{{ t('detail.strategy.h1') }}</h1>

      </div>

      <div class="detail-card mb-20">
        <p class="text-white/70 text-lg leading-relaxed">
          {{ t('detail.strategy.intro') }}
        </p>
        <h2 class="text-xl font-bold mb-5">{{ t('detail.whatWeOffer') }}</h2>
        <ul class="offer-list mb-10">
          <li v-for="item in offers" :key="item">{{ item }}</li>
        </ul>
        <NuxtLink :to="localePath('/contact')" class="btn-primary">{{ t('detail.strategy.moreBtn') }}</NuxtLink>
      </div>
    ...
    <div class="relative z-10 py-20 px-6 text-center border-t border-white/10">
      <div class="max-w-xl mx-auto">
        <p class="text-white/70 text-lg mb-6">{{ t('detail.strategy.ctaText') }}</p>
...
const subMeta = [
  { image: '/images/pexels-khwanchai-4175028.jpg', href: '/contact' },
  { image: '/images/newland_cover_v1.png', href: '/contact' },
  { image: '/images/newland_cover_v4.png', href: '/contact' },
]
const subSections = computed(() =>
  (tm('detail.strategy.sub') as any[]).map((s, i) => ({
