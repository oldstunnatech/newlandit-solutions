<template>
  <section class="legal-page text-white">
    <div class="max-w-3xl mx-auto px-6 pt-32 pb-24">
      ...
      <h1 class="text-3xl sm:text-4xl font-extrabold mb-2 mt-8">{{ t('legal.cookies.title') }}</h1>
      <p class="text-white/40 text-sm mb-10">{{ t('legal.lastUpdated') }}</p>
      <p class="text-white/80 leading-relaxed mb-12 text-lg">{{ t('legal.cookies.intro') }}</p>
      <div
        v-for="section in (tm('legal.cookies.sections') as any[])"
